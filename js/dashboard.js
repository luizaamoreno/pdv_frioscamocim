...
function updateChartColors() {
    ...
    // Atualiza as cores do gráfico de vendas por hora
    ...
    // Atualiza as cores do gráfico de métodos de pagamento
...
function getSalesByHour(date) {
    ...
    console.log('Vendas: R$', salesByHour);
    return salesByHour;
}
...
function updatePaymentMethods() {
    ...
    const distribution = getPaymentMethodDistribution(firstDayOfMonth, today);
